...
margin:auto;	width: 200px;	height: 41px;
    ...
    <%
    //out.println(session.getAttribute("log")==null);
            ...
            }else
{
    ...
    <table cellpadding="5px">
        ...
        <tr>
         ...
         <tr>
            <td>
                <a id="HyperLink9" href="LogOut.jsp" target="_parent" style="display:inline-block;height:30px;width:150px;">Logout</a>
            </td>
        </tr>
    </tbody></table>
    </div>
    <div id="Div1" style="float:right;width:83%"> 
             <iframe id="MainWindow" onload="resizeIframe(this);" name="MainWindow" width="100%" scrolling="yes" frameborder="0" style="height: 500px;"></iframe>
    </div>
    </div>
    </form>
</body></html>
